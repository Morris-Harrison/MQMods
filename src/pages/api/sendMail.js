...
export default async function handler(req, res) {
  ...
  try {
    const { cart, name, address, additionalContact, email } = req.body;
    ...
    const emailBody = buildEmailText({ cart, name, address, additionalContact });
 ...
 */
function buildEmailText({ cart, name, address, additionalContact }) {
...
Order type: Full Phob Controller
